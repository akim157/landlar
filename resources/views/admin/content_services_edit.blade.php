<div class="wrapper container-fluid">
    {!! Form::open(['url' => route('service_edit', array('service' => $data['id'])),'class'=>'form-horizontal','method'=>'POST','enctype'=>'multipart/form-data']) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::text('icon', $data['icon'], ['class' => 'form-control','placeholder'=>'Введите наименовая иконки']) !!}
        </div>
    </div>
