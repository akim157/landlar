<div class="wrapper container-fluid">
    {!! Form::open(['url' => route('portfolio_edit',array('portfolio'=>$data['id'])),'class'=>'form-horizontal','method'=>'POST','enctype'=>'multipart/form-data']) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::text('filter', $data['filter'],['class' => 'form-control','placeholder'=>'Введите название фильтра для портфолио'])!!}
        </div>
    </div>
